...
public class FixedOrderComparator<T> implements Comparator<T>, Serializable {
	 ...
	 *
	 * @param unknownObjectBehavior the flag for unknown behaviour - UNKNOWN_AFTER,
	 ...
	 * @param newObj      an item to be added to the Comparator's set of known
	 *                    objects
	 ...
	 *                                  Comparator and an alternative behavior has
	 *                                  not been set via
