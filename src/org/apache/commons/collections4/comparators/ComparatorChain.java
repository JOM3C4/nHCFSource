...
public class ComparatorChain<E> implements Comparator<E>, Serializable {
	...
	/**
	 * Construct a ComparatorChain from the Comparators in the List. All Comparators
	...
	/**
	 * Construct a ComparatorChain from the Comparators in the given List. The sort
	 * order of each column will be drawn from the given BitSet. When determining
	 * the sort order for Comparator at index <i>i</i> in the List, the
	 ...
	 * @param bits Sort order for each Comparator. Extra bits are ignored, unless
	 ...
	 * @return -1, 0, or 1
	 * @throws UnsupportedOperationException if the ComparatorChain does not contain
