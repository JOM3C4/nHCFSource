...
public class CompositeMap<K, V> extends AbstractIterableMap<K, V> implements Serializable {
	 ...
	 *
	 * @throws UnsupportedOperationException if any of the composited Maps do not
	 *                                       support clear()
	 */
	public void clear() {
	 ...
	 *                              map (optional).
	 * @throws NullPointerException if the key is {@code null} and this map does not
	 ...
	 *                              this map (optional).
	 * @throws NullPointerException if the value is {@code null} and this map does
	 *                              not not permit {@code null} values (optional).
	 */
	 ...
	 * @throws ClassCastException   if the key is of an inappropriate type for this
	 *                              map (optional).
	 * @throws NullPointerException key is {@code null} and this map does not not
	 ...
	 *                                       specified map prevents it from being
	 *                                       stored in this map.
	 * @throws NullPointerException          the specified map is {@code null}, or
	 *                                       if this map does not permit
	 *                                       {@code null} keys or values, and the
	 *                                       specified map contains {@code null}
	 *                                       keys or values.
	 */
	...
	public static interface MapMutator<K, V> extends Serializable {
		 ...
		 * @param intersect the intersection of the keysets of the existing and added
		 *                  maps
		 */
