...
public abstract class AbstractReferenceMap<K, V> extends AbstractHashedMap<K, V> {
	 ...
	 *
	 * @param keyType     the type of reference to use for keys; must be
	 *                    {@link ReferenceStrength#HARD HARD},
	 *                    {@link ReferenceStrength#SOFT SOFT},
	 *                    {@link ReferenceStrength#WEAK WEAK}
	 * @param valueType   the type of reference to use for values; must be
	 *                    {@link ReferenceStrength#HARD},
	 *                    {@link ReferenceStrength#SOFT SOFT},
	 *                    {@link ReferenceStrength#WEAK WEAK}
	 * @param capacity    the initial capacity for the map
	 * @param loadFactor  the load factor for the map
	 * @param purgeValues should the value be automatically purged when the key is
	 *                    garbage collected
	 */
	...
	protected static class ReferenceEntry<K, V> extends HashEntry<K, V> {
		 ...
		 * @param hash     the hash code of the <i>key</i> of the mapping; this number
		 *                 might be different from referent.hashCode() if the referent
