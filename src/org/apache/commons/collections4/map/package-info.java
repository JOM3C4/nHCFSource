 ...
 * {@link java.util.SortedMap SortedMap} interfaces. A Map provides a lookup
 * from a key to a value. A number of implementations also support the new
 * MapIterator interface that enables simple iteration of map keys and values.
 * <p>
 ...
 * OrderedMapIterator
 * <li>LRUMap - a hash map that maintains a maximum size by removing the least
 * recently used entries
 * <li>MultiKeyMap - map that provides special methods for using more than one
 ...
 * <li>ReferenceIdentityMap - allows the garbage collector to collect keys and
 * values using == for comparison
