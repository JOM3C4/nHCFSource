...
public class LRUMap<K, V> extends AbstractLinkedMap<K, V> implements BoundedMap<K, V>, Serializable, Cloneable {
	 ...
	 * @throws IllegalArgumentException if the maximum size is less than one
	 * @throws IllegalArgumentException if the initial size is negative or larger
	 ...
	 *
	 * @param maxSize            the maximum size of the map
	 * @param scanUntilRemovable scan until a removeable entry is found, default
	 *                           false
	 * @throws IllegalArgumentException if the maximum size is less than one
	 * @since 3.1
	 */
	 ...
	 *
	 * @param key         the key
	 * @param updateToMRU whether the key shall be updated to the most recently used
	 *                    position
	 * @return the mapped value, null if no match
	 * @since 4.1
	 */
