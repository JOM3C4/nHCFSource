...
public interface MultiValuedMap<K, V> {
	 ...
	 * @throws NullPointerException if the value is null and null values are not
	 *                              supported by the used collection types
	 *                              (optional)
	 */
	 ...
	 *                                       by this multi-valued map, e.g. if it is
	 *                                       unmodifiable
	 ...
	 * @throws NullPointerException if the specified iterable is null, or if this
	 *                              map does not permit null keys or values, and the
	 *                              specified key or values contain null (optional)
	 */
