...
public interface BidiMap<K, V> extends IterableMap<K, V> {
	 ...
	 *                                       supported
	 * @throws ClassCastException            (optional) if the map limits the type
	 *                                       of the value and the specified value is
	 *                                       inappropriate
	 * @throws IllegalArgumentException      (optional) if the map limits the values
	 *                                       in some way and the value was invalid
	 * @throws NullPointerException          (optional) if the map limits the values
	 *                                       to non-null and null was specified
	 */
	V put(K key, V value);
