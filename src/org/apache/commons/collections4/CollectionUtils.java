...
public class CollectionUtils {
	 ...
	 * @param <O> the generic type that is able to represent the types contained in
	 ...
	 * @param predicate        the predicate to use, may be null
	 * @param outputCollection the collection to output into, may not be null if the
	 ...
	 * @param inputCollection    the collection to get the input from, may be null
	 * @param predicate          the predicate to use, may be null
	 * @param outputCollection   the collection to output selected elements into,
	 *                           may not be null if the inputCollection and
	 *                           predicate are not null
	 * @param rejectedCollection the collection to output rejected elements into,
	 *                           may not be null if the inputCollection or predicate
	 *                           are not null
	 * @return the outputCollection
	 * @since 4.1
	 */
	 ...
	 * @param inputCollection  the collection to get the input from, may be null
	 * @param transformer      the transformer to use, may be null
	 * @param outputCollection the collection to output into, may not be null if
	 ...
	 * no such element.
	 * <p>
	 * If the {@link Iterable} is a {@link List}, then it will use
	 * {@link List#get(int)}.
	 *
