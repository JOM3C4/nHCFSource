...
public class CompositeCollection<E> implements Collection<E>, Serializable {
	 ...
	 * @throws ClassCastException            if the object cannot be added due to
	 *                                       its type
	 ...
	 * @throws ClassCastException            if the object cannot be removed due to
	 *                                       its type
	 * @throws NullPointerException          if the object cannot be removed because
	 *                                       its null
