...
public interface MultiSet<E> extends Collection<E> {
	 ...
	 *
	 * @param object      the object to add
	 * @param occurrences the number of occurrences to add, may be zero, in which
	 *                    case no change is made to the multiset
	 ...
	 *
	 * @param object      the object to remove
	 * @param occurrences the number of occurrences to remove, may be zero, in which
	 *                    case no change is made to the multiset
