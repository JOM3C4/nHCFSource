...
public class PeekingIterator<E> implements Iterator<E> {
	 ...
	 *
	 * @return the next element from the iterator
	 * @throws NoSuchElementException if the iterator is already exhausted according
	 *                                to {@link #hasNext()}
	 */
	public E element() {
		fill();
	 ...
	 * {@inheritDoc}
	 *
	 * @throws IllegalStateException if {@link #peek()} or {@link #element()} has
	 *                               been called prior to the call to
	 *                               {@link #remove()}
	 */
	public void remove() {
		if (slotFilled) {
