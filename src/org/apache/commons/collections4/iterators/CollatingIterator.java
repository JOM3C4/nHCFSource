...
public class CollatingIterator<E> implements Iterator<E> {
	 ...
	 *
	 * @param comp the comparator to use to sort; must not be null, unless you'll be
	 ...
	 *                         unless you'll be invoking
	 *                         {@link #setComparator(Comparator)} later on.
	 * @param initIterCapacity the initial capacity for the internal list of child
	 *                         iterators
	 */
	 ...
	 *
	 * @param comp      the comparator to use to sort; must not be null, unless
	 *                  you'll be invoking {@link #setComparator(Comparator)} later
	 *                  on.
	 ...
	 * @throws ClassCastException   if the iterators collection contains an element
	 *                              that's not an {@link Iterator}
	 */
	 ...
	 *
	 * @throws IllegalStateException if there is no last returned element, or if the
	 *                               last returned element has already been removed
	 */
	public void remove() {
		if (lastReturned == -1) {
