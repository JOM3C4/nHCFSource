...
public class SingletonListIterator<E> implements ResettableListIterator<E> {
	 ...
	 *
	 * @return the single object
	 * @throws NoSuchElementException if the single object has not already been
	 *                                returned
	 */
	public E previous() {
		if (beforeFirst || removed) {
	 ...
	 * 
	 * @throws IllegalStateException if the {@code next} or {@code previous} method
	 *                               has not yet been called, or the {@code remove}
	 ...
	 * @throws IllegalStateException if {@code next} has not been called or the
