...
public class ComparatorUtils {
	 ...
	 *
	 * @param <E>         the object type to compare
	 * @param comparators the comparators to use, not null or empty or containing
	 *                    nulls
	 ...
	 *                    nulls
	 * @return a {@link ComparatorChain} formed from the input comparators
	 * @throws NullPointerException if comparators collection is null or contains a
	 *                              null
	 * @throws ClassCastException   if the comparators collection contains the wrong
	 *                              object type
	 * @see ComparatorChain
	 */
	@SuppressWarnings("unchecked")
	 ...
	 *
	 * @param trueFirst when <code>true</code>, sort <code>true</code>
	 *                  {@link Boolean}s before <code>false</code> {@link Boolean}s.
