...
public class IterableUtils {
	 ...
	 *
	 * @param <E>        the element type
	 * @param comparator the comparator defining an ordering over the elements, may
	 *                   be null, in which case natural ordering will be used
	 * @param a          the first iterable, may not be null
	 * @param b          the second iterable, may not be null
	 * @return a filtered view on the specified iterable
	 * @throws NullPointerException if either of the provided iterables is null
	 ...
	 * otherwise an intermediate {@link List} needs to be created.
	 * <p>
	 * The returned iterable's iterator supports {@code remove()} if the provided
	 * iterable is a {@link List} instance.
	 *
	 * @param <E>      the element type
	 ...
	 * @param <E>            the element type
	 * @param iterable       the iterable to use, may not be null
	 * @param elementsToSkip the number of elements to skip from the start, must not
	 *                       be negative
