...
public abstract class AbstractLinkedList<E> implements List<E> {
	 ...
	 * @throws IndexOutOfBoundsException if the index is less than 0; equal to the
	 *                                   size of the list and endMakerAllowed is
	 ...
	 * @throws IOException            if any error occurs while reading from the
	 *                                stream
	 * @throws ClassNotFoundException if a class read from the stream can not be
	 *                                loaded
	 */
	@SuppressWarnings("unchecked")
	...
	protected static class LinkedListIterator<E> implements ListIterator<E>, OrderedIterator<E> {
		 ...
		 *                               haven't been called, or if the node has been
		 *                               removed with {@link #remove()} or a new node
