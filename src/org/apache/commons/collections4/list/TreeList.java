...
//  LinkedList =  270;7360;3350;55860;290720;2910;55200;
	...
	static class AVLNode<E> {
		 ...
		 *                                 already point to the element at index
		 *                                 {@code start} within the collection
		 * @param start                    the index of the first element in the
		 *                                 collection that should be in this subtree
		 * @param end                      the index of the last element in the
		 *                                 collection that should be in this subtree
		 * @param absolutePositionOfParent absolute position of this node's parent, or 0
		 *                                 if this node is the root
		 * @param prev                     the {@code AVLNode} corresponding to element
		 *                                 (start - 1) of the collection, or null if
		 *                                 start is 0
		 * @param next                     the {@code AVLNode} corresponding to element
		 *                                 (end + 1) of the collection, or null if end
...
//        }
	...
	static class TreeListIterator<E> implements ListIterator<E>, OrderedIterator<E> {
		 ...
		 * expects.
		 *
		 * @throws ConcurrentModificationException If the list's modification count
		 *                                         isn't the value that was expected.
		 */
