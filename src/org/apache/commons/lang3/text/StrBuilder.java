...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
	 ...
	 * that, call <code>clear()</code> followed by {@link #minimizeCapacity()}.
	 * <p>
	...
	public <T> StrBuilder appendAll(@SuppressWarnings("unchecked") final T... array) {
		 ...
		 * use @SafeVarargs, since this method is not final. Using @SupressWarnings is
	 ...
	 * <code>toString</code> of the object is used. If the object is larger than the
	 ...
	 * <p>
	 * Matchers can be used to perform advanced deletion behaviour. For example you
	 ...
	 * matcher.
	 * <p>
	 * Matchers can be used to perform advanced searching behaviour. For example you
	 ...
	 * <p>
	 * To use, simply create a <code>StrBuilder</code>, populate it with data, call
	 * <code>asReader</code>, and then read away.
	 * <p>
	 ...
	 * and populate away. The data is available at any time using the methods of the
