...
public class StringUtils {
	 ...
	 * sequence represented by the <code>seq</code> <code>CharSequence</code> object
	 * at an index no smaller than <code>startPos</code>, then the index of the
	 * first such occurrence is returned. For values of <code>searchChar</code> in
	 * the range from 0 to 0xFFFF (inclusive), this is the smallest value <i>k</i>
	 ...
	 * specified character. For values of <code>searchChar</code> in the range from
	 * 0 to 0xFFFF (inclusive), the index (in Unicode code units) returned is the
	 ...
	 * string, then <code>-1</code> is returned. Furthermore, a {@code null} or
	 * empty ("") <code>CharSequence</code> will return {@code -1}. The
	...
	/**
	 * Returns the index within <code>seq</code> of the last occurrence of the
	 * specified character, searching backward starting at the specified index. For
	 * values of <code>searchChar</code> in the range from 0 to 0xFFFF (inclusive),
	 ...
	 * <code>startPos</code> and works backwards; matches starting after the start
	 ...
	 * surrogate not followed by a low surrogate or a low surrogate not preceeded by
