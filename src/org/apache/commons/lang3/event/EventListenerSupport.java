...
public class EventListenerSupport<L> implements Serializable {
	...
	/**
	 * The list used to hold the registered listeners. This list is intentionally a
	 * thread-safe copy-on-write-array so that traversals over the list of listeners
	 * will be atomic.
	 */
	...
	/**
	 * Creates an EventListenerSupport object which supports the specified listener
	 * type.
	 *
	 ...
	 *
	 * @return an EventListenerSupport object which supports the specified listener
	 *         type.
	 *
	 * @throws NullPointerException     if <code>listenerInterface</code> is
	 *                                  <code>null</code>.
	 * @throws IllegalArgumentException if <code>listenerInterface</code> is not an
	 *                                  interface.
	 */
...
//**********************************************************************************************************************
	...
	/**
	 * Registers an event listener. Will not add a pre-existing listener object to
	 * the list if <code>allowDuplicate</code> is false.
	 *
	 * @param listener       the event listener (may not be <code>null</code>).
	 * @param allowDuplicate the flag for determining if duplicate listener objects
	...
	/**
	 * Get an array containing the currently registered listeners. Modification to
	 * this array's elements will have no effect on the {@link EventListenerSupport}
	 * instance.
	 * 
	 * @return L[]
	 */
	...
	private void writeObject(final ObjectOutputStream objectOutputStream) throws IOException {
		...
		/*
		 * we can reconstitute everything we need from an array of our listeners, which
		 * has the additional advantage of typically requiring less storage than a list:
		 */
	...
	/**
	 * Create the {@link InvocationHandler} responsible for broadcasting calls to
	 * the managed listeners. Subclasses can override to provide custom behavior.
	 * 
