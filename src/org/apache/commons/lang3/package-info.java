 ...
 * </p>
 *
 * <h3>String manipulation - StringUtils, StringEscapeUtils,
 ...
 * to begin with. If you use java.sql.Statements a lot,
 * StringEscapeUtils.escapeSql might be of interest.
 * </p>
 *
 ...
 * <code>CharSetUtils.delete("testtest", "tr")</code> will remove all t's and
 * all r's from the String, not just the String "tr".
 * </p>
 *
 * <p>
 ...
 * few JDK 1.3 bits that had slipped in (<code>Collections.EMPTY_MAP</code> is a
 ...
 * sorting <code>java</code> and <code>javax</code> first.
 * </p>
 *
 * <p>
 ...
 * <li><code>contains(xxx[], xxx)</code> searches for a primitive or Object in a
 ...
 * <li><code>indexOf(xxx[], xxx)</code> and
 * <code>indexOf(xxx[], xxx, int)</code> are copies of the classic String
 * methods, but this time for primitive/Object arrays. In addition, a
 * lastIndexOf set of methods exists.</li>
 * <li><code>isEmpty(xxx[])</code> lets you know if an array is zero-sized or
 * null.</li>
 * <li><code>isSameLength(xxx[], xxx[])</code> returns true if the arrays are
 * the same length.</li>
 * <li>Along side the add methods, there are also remove methods of two types.
 * The first type remove the value at an index, <code>remove(xxx[], int)</code>,
 ...
 * array around.</li>
 * <li>The <code>subarray(xxx[], int, int)</code> method splices an array out of
 * a larger array.</li>
 * <li>Primitive to primitive wrapper conversion is handled by the
 * <code>toObject(xxx[])</code> and <code>toPrimitive(Xxx[])</code> methods.
 * </li>
 * </ul>
 *
 * <p>
