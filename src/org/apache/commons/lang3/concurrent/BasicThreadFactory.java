...
public class BasicThreadFactory implements ThreadFactory {
	...
	/**
	 * Returns the wrapped {@code ThreadFactory}. This factory is used for actually
	 * creating threads. This method never returns <b>null</b>. If no
	...
	/**
	 * Returns the {@code UncaughtExceptionHandler} for the threads created by this
	 * factory. Result can be <b>null</b> if no handler was provided.
	 *
	 ...
	 * for creating the thread. Then, on the newly created thread the corresponding
	...
	public static class Builder implements org.apache.commons.lang3.builder.Builder<BasicThreadFactory> {
		 ...
		 * @throws NullPointerException if the passed in {@code ThreadFactory} is
		 *                              <b>null</b>
		 */
		...
		/**
		 * Sets the daemon flag for the new {@code BasicThreadFactory}. If this flag is
		 * set to <b>true</b> the new thread factory will create daemon threads.
		 *
		 ...
		 * Note: If the {@link #build()} method was called, it is not necessary to call
		 * {@code reset()} explicitly because this is done automatically.
		 */
		public void reset() {
			wrappedFactory = null;
		...
		/**
		 * Creates a new {@code BasicThreadFactory} with all configuration options that
		 * have been specified by calling methods on this builder. After creating the
		 * factory {@link #reset()} is called.
		 *
