...
public class Memoizer<I, O> implements Computable<I, O> {
	 ...
	 * </p>
	 * <p>
	 * If a calculation is thrown an exception for any reason, this exception will
	 * be cached and returned for all future calls with the provided parameter.
	 * </p>
	 *
	 ...
	 * option of whether a Computation that experiences an error should recalculate
	 * on subsequent calls or return the same cached exception.
	 * </p>
	 *
	 * @param computable  the computation whose results should be memorized
	 * @param recalculate determines whether the computation should be recalculated
	 *                    on subsequent calls if the previous call failed
	 */
	...
	/**
	 * <p>
	 * This method will return the result of the calculation and cache it, if it has
	 * not previously been calculated.
	 * </p>
	 * <p>
	 * This cache will also cache exceptions that occur during the computation if
	 * the {@code recalculate} parameter is the constructor was set to
	...
	/**
	 * <p>
	 * This method launders a Throwable to either a RuntimeException, Error or any
	 * other Exception wrapped in an IllegalStateException.
	 * </p>
	 *
