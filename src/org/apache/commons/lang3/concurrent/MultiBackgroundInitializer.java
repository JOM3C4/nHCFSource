...
public class MultiBackgroundInitializer
	...
	/**
	 * Creates a new instance of {@code MultiBackgroundInitializer} and initializes
	 ...
	 * {@code MultiBackgroundInitializer} is started, the given initializer will be
	 * processed. This method must not be called after {@link #start()} has been
	 * invoked.
	 *
	 ...
	 * BackgroundInitializer} objects in parallel. This implementation sums up the
	 * required tasks for all child initializers (which is necessary if one of the
	 * child initializers is itself a {@code MultiBackgroundInitializer} ). Then it
	 * adds 1 for the control task that waits for the completion of the children.
	 *
	 ...
	 * BackgroundInitializer} objects. Then it collects their results and creates a
	 * {@code MultiBackgroundInitializerResults} object with this data. If a child
	 * initializer throws a checked exceptions, it is added to the results object.
	 * Unchecked exceptions are propagated.
	 *
	 ...
	 * performed by {@code MultiBackgroundInitializer}. Objects of this inner class
	 * are returned by {@link MultiBackgroundInitializer#initialize()}. They allow
	 * access to all result objects produced by the {@link BackgroundInitializer}
	 * objects managed by the owning instance. It is also possible to retrieve
	 * status information about single {@link BackgroundInitializer}s, i.e. whether
	...
	public static class MultiBackgroundInitializerResults {
		 ...
		 * initializes it with maps for the {@code BackgroundInitializer} objects, their
		...
		/**
		 * Returns the {@code BackgroundInitializer} with the given name. If the name
		 ...
		 * BackgroundInitializer} with the given name. This is the object returned by
		 * the initializer's {@code initialize()} method. If this
		 * {@code BackgroundInitializer} caused an exception, <b>null</b> is returned.
		 * If the name cannot be resolved, an exception is thrown.
		 *
		 * @param name the name of the {@code BackgroundInitializer}
		...
		/**
		 * Returns a flag whether the {@code BackgroundInitializer} with the given name
		 * caused an exception.
		 *
		 * @param name the name of the {@code BackgroundInitializer}
		 ...
		 * {@code BackgroundInitializer} with the given name. If this initializer did
		 * not throw an exception, the return value is <b>null</b>. If the name cannot
		...
		/**
		 * Returns a flag whether the whole initialization was successful. This is the
		 * case if no child initializer has thrown an exception.
		 *
		...
		/**
		 * Checks whether an initializer with the given name exists. If not, throws an
		 * exception. If it exists, the associated child initializer is returned.
		 *
