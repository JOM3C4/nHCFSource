...
public abstract class AtomicSafeInitializer<T> implements ConcurrentInitializer<T> {
	...
	/**
	 * Creates and initializes the object managed by this {@code AtomicInitializer}.
	 * This method is called by {@link #get()} when the managed object is not
	 * available yet. An implementation can focus on the creation of the object. No
	 * synchronization is needed, as this is already handled by {@code get()}. This
	 * method is guaranteed to be called only once.
	 *
