...
public class CallableBackgroundInitializer<T> extends BackgroundInitializer<T> {
	 ...
	 * {@code Callable} to be executed in a background thread.
	 *
	 ...
	 * thread and the {@code ExecutorService} for managing the background execution.
	 *
	 * @param call the {@code Callable} (must not be <b>null</b>)
	...
	/**
	 * Performs initialization in a background thread. This implementation delegates
	 * to the {@code Callable} passed at construction time of this object.
	 *
