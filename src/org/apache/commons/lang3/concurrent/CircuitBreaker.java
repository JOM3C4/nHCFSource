...
public interface CircuitBreaker<T> {
	 ...
	 * <strong>true</strong> means that the circuit breaker is currently closed.
	 * This means that everything is okay with the monitored sub system.
	 *
	...
	/**
	 * Increments the monitored value and performs a check of the current state of
	 * this circuit breaker. This method works like {@link #checkState()}, but the
	 * monitored value is incremented before the state check is performed.
	 *
	 * @param increment value to increment in the monitored value of the circuit
	 *                  breaker
	 * @return <strong>true</strong> if the circuit breaker is now closed;
	 *         <strong>false</strong> otherwise
	 */
