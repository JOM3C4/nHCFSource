...
public abstract class AtomicInitializer<T> implements ConcurrentInitializer<T> {
	 ...
	 * @throws ConcurrentException if an error occurred during initialization of the
	 *                             object
	 */
	@Override
	 ...
	 * AtomicInitializer}. This method is called by {@link #get()} when the managed
	 * object is not available yet. An implementation can focus on the creation of
	 * the object. No synchronization is needed, as this is already handled by
	 * {@code get()}. As stated by the class comment, it is possible that this
