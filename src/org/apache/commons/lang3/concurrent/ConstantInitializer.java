...
public class ConstantInitializer<T> implements ConcurrentInitializer<T> {
	...
	/**
	 * Creates a new instance of {@code ConstantInitializer} and initializes it with
	 * the object to be managed. The {@code get()} method will always return the
	 * object passed here. This class does not place any restrictions on the object.
	 * It may be <b>null</b>, then {@code get()} will return <b>null</b>, too.
	 *
	...
	/**
	 * Directly returns the object that was passed to the constructor. This is the
	 * same object as returned by {@code get()}. However, this method does not
	 * declare that it throws an exception.
	 *
	 ...
	 * {@code ConstantInitializer} which refers to an object equals to the object
	...
	/**
	 * Returns a string representation for this object. This string also contains a
	 * string representation of the object managed by this initializer.
	 *
