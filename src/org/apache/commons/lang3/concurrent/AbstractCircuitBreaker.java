...
public abstract class AbstractCircuitBreaker<T> implements CircuitBreaker<T> {
	/**
	 * The name of the <em>open</em> property as it is passed to registered change
	 * listeners.
	 */
	...
	/**
	 * Changes the internal state of this circuit breaker. If there is actually a
	 * change of the state value, all registered change listeners are notified.
	 *
	...
	/**
	 * Adds a change listener to this circuit breaker. This listener is notified
	 * whenever the state of this circuit breaker changes. If the listener is
	...
	protected static enum State {
		...
		/**
		 * Returns the opposite state to the represented state. This is useful for
