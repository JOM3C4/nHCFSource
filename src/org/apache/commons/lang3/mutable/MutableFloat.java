...
public class MutableFloat extends Number implements Comparable<MutableFloat>, Mutable<Number> {
	 ...
	 * a <code>Float</code> object that represents a <code>float</code> that has the
	 * identical bit pattern to the bit pattern of the <code>float</code>
	 * represented by this object. For this purpose, two float values are considered
	 ...
	 * <code>Float</code>,<code>f1</code> and <code>f2</code>, the value of
	 ...
	 * represents <code>-0.0f</code>, or vice versa, the <code>equal</code> test has
	 * the value <code>false</code>, even though <code>0.0f==-0.0f</code> has the
