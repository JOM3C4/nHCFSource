...
public abstract class ToStringStyle implements Serializable {
	...
	/**
	 * The no field names toString style. Using the <code>Person</code> example from
	 * {@link ToStringBuilder}, the output would look like this:
	 *
	 * <pre>
	...
	/**
	 * The no class name toString style. Using the <code>Person</code> example from
	 * {@link ToStringBuilder}, the output would look like this:
	 *
	 * <pre>
	...
	/**
	 * <p>
	 * Append to the <code>toString</code> an <code>Object</code> value, printing a
	 * summary of the <code>Object</code>.
	 * </P>
	 *
	 * @param buffer    the <code>StringBuffer</code> to populate
	 * @param fieldName the field name, typically not used as already appended
	 ...
	 * may request full detail (<code>true</code>), but a subclass might ignore that
	 * and always return <code>false</code>. The calling code may pass in
	 * <code>null</code> indicating that it doesn't care about the detail level. In
	 * this case the default detail level is used.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * <code>ToStringStyle</code> that does not print out the classname and identity
	 * hash code but prints content start and field names.
	 * </p>
	 *
	 * <p>
	 * This is an inner class rather than using <code>StandardToStringStyle</code>
