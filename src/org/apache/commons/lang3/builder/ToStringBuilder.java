...
public class ToStringBuilder implements Builder<String> {
	 ...
	 * latest value set using {@link #setDefaultStyle} is the value returned. It is
	 * strongly recommended that the default style is only changed during
	 * application startup.
	 * </p>
	 *
	 * <p>
	 ...
	 * </p>
	 *
	 * @param object the Object to build a <code>toString</code> for, not
	 ...
	 * @param object the Object to build a <code>toString</code> for, not
	 *               recommended to be null
	 * @param style  the style of the <code>toString</code> to create, null uses the
	 *               default style
	 */
