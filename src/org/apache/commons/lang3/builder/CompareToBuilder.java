 ...
 * 
 * <p>
 * Values are compared in the order they are appended to the builder. If any
 * comparison returns a non-zero result, then that value will be the result
 * returned by {@code toComparison()} and all subsequent comparisons are
 * skipped.
 * </p>
 *
 * <p>
 ...
 * first, followed by those of its parent classes (in order from the bottom to
...
public class CompareToBuilder implements Builder<Integer> {
	 ...
	 *
	 * <p>
	 * Starts off assuming that the objects are equal. Multiple calls are then made
	 * to the various append methods, followed by a call to {@link #toComparison} to
	 * get the result.
	 * </p>
	 */
