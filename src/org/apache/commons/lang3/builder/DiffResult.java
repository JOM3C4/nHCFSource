 ...
 * </p>
 * <p>
 * Use a {@link DiffBuilder} to build a {@code DiffResult} comparing two
 * objects.
 * </p>
 * 
 * @since 3.3
...
public class DiffResult implements Iterable<Diff<?>> {
	 ...
	 *              {@code null}, in which case {@link ToStringStyle#DEFAULT_STYLE}
	 *              is used
	 * @throws IllegalArgumentException if {@code lhs}, {@code rhs} or {@code diffs}
	 *                                  is {@code null}
	 */
	...
	/**
	 * <p>
	 * Returns an unmodifiable list of {@code Diff}s. The list may be empty if there
	 * were no differences between the objects.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Builds a {@code String} description of the differences contained within this
	 * {@code DiffResult}. A {@link ToStringBuilder} is used for each object and the
	 * style of the output is governed by the {@code ToStringStyle} passed to the
	 * constructor.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This indicates that the objects differ in name and age, but not in smoking
	 * status.
	 * </p>
	 * 
	 * <p>
	 * To use a different {@code ToStringStyle} for an instance of this class, use
	 * {@link #toString(ToStringStyle)}.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Builds a {@code String} description of the differences contained within this
	 * {@code DiffResult}, using the supplied {@code ToStringStyle}.
	 * </p>
	 * 
