 ...
 * protection guarding access to these fields. If a toString method cannot
 * safely read a field, you should exclude it from the toString method, or use
 * synchronization consistent with the class' lock management around the
 * invocation of the method. Take special care to exclude non-thread-safe
 * collection classes, because these classes may throw
 * ConcurrentModificationException if modified while the toString method is
 * executing.
 * </p>
 * <p>
 ...
 * </pre>
 * <p>
 * Alternatively the {@link ToStringExclude} annotation can be used to exclude
 * fields from being incorporated in the result.
 * </p>
 * <p>
 ...
 * formatting, i.e. composed objects are not further traversed. To get "deep"
 * formatting, use an instance of {@link RecursiveToStringStyle}.
 * </p>
 *
 * @since 2.0
 */
public class ReflectionToStringBuilder extends ToStringBuilder {
	 ...
	 *
	 * <p>
	 * Transient members will be not be included, as they are likely derived. Static
	 ...
	 *               <code>null</code>
	 * @return the String result
	 * @throws IllegalArgumentException if the Object or <code>ToStringStyle</code>
	 *                                  is <code>null</code>
	 *
	 * @see ToStringExclude
	 */
	 ...
	 *
	 * @param excludeFieldNamesParam The excludeFieldNames to excluding from
	 *                               toString or <code>null</code>.
