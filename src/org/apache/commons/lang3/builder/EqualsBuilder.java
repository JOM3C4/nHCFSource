...
public class EqualsBuilder implements Builder<Boolean> {
	 ...
	 * code really are equal, so we also need to ensure that the replacement objects
	 * are only equal if the original objects are identical.
	 *
	 * The original implementation (2.4 and before) used the
	 * System.identityHashCode() method - however this is not guaranteed to generate
	 * unique ids (e.g. LANG-459)
	 *
	 ...
	 * 
	 * <p>
	 * If the testTransients field is set to <code>true</code>, transient members
	 * will be tested, otherwise they are ignored, as they are likely derived
	 * fields, and not part of the value of the <code>Object</code>.
	 * </p>
	 *
	 * <p>
	 * Static fields will not be included. Superclass fields will be appended up to
	 * and including the specified superclass in field
	 ...
	 * #{@link #reflectionAppend(Object, Object)}, if object are non primitives (or
	 * wrapper of primitives) or if field <code>testRecursive</code> is set to
	 * <code>false</code>. Otherwise, using their <code>equals</code> method.
	 * </p>
	 *
	 * @param lhs the left hand object
	 * @param rhs the right hand object
