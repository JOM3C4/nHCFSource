...
public class DiffBuilder implements Builder<DiffResult> {
	 ...
	 * 
	 * <p>
	 * If {@code lhs == rhs} or {@code lhs.equals(rhs)} then the builder will not
	 * evaluate any calls to {@code append(...)} and will return an empty
	 * {@link DiffResult} when {@link #build()} is executed.
	 * </p>
	 * 
	 * @param lhs                {@code this} object
	 * @param rhs                the object to diff against
	 * @param style              the style will use when outputting the objects,
	 *                           {@code null} uses the default
	 * @param testTriviallyEqual If true, this will test if lhs and rhs are the same
	 *                           or equal. All of the append(fieldName, lhs, rhs)
	 *                           methods will abort without creating a field
	 *                           {@link Diff} if the trivially equal test is enabled
	 *                           and returns true. The result of this test is never
	 *                           changed throughout the life of this
	 *                           {@link DiffBuilder}.
	 * @throws IllegalArgumentException if {@code lhs} or {@code rhs} is
	 *                                  {@code null}
	 * @since 3.4
	 */
	 ...
	 * 
	 * <p>
	 * This method is useful if you want to compare properties which are themselves
	 * Diffable and would like to know which specific part of it is different.
	 * </p>
	 * 
	 * <pre>
	 * public class Person implements Diffable&lt;Person&gt; {
