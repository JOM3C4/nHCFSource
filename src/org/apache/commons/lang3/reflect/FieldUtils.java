...
public class FieldUtils {
	...
	/**
	 * Gets an accessible {@link Field} by name respecting scope. Only the specified
	 ...
	 * 
	 * @param cls           the {@link Class} to query
	 * @param annotationCls the {@link Annotation} that must be present on a field
	 *                      to be matched
	 * @return an array of Fields (possibly empty).
	 ...
	 * @throws IllegalArgumentException if the field is {@code null}, or not
	 *                                  {@code static}
	 ...
	 * @throws IllegalArgumentException if the class is {@code null}, or the field
	 *                                  name is blank or empty, is not
	 *                                  {@code static}, or could not be found
	 * @throws IllegalAccessException   if the field is not accessible
	 */
	...
	/**
	 * Gets the value of a {@code static} {@link Field} by name. The field must be
	 * {@code public}. Only the specified class will be considered.
	 * 
	 * @param cls       the {@link Class} to reflect, must not be {@code null}
	 * @param fieldName the field name to obtain
	 * @return the value of the field
	...
	/**
	 * Gets the value of a {@code static} {@link Field} by name. Only the specified
	 * class will be considered.
	 * 
	 * @param cls         the {@link Class} to reflect, must not be {@code null}
	 * @param fieldName   the field name to obtain
	 ...
	 * @param target the object to call on, may be {@code null} for {@code static}
	 *               fields
	 * @return the field value
	 ...
	 * 
	 * @param field       the field to use
	 * @param target      the object to call on, may be {@code null} for
	 *                    {@code static} fields
	 * @param forceAccess whether to break scope restrictions using the
	 *                    {@link java.lang.reflect.AccessibleObject#setAccessible(boolean)}
	 *                    method.
	 ...
	 * @return the value of the field
	 * @throws IllegalArgumentException if the class is {@code null}, or the field
	 *                                  name is blank or empty or could not be found
	...
	/**
	 * Reads the named {@code public} {@link Field}. Only the class of the specified
	...
	/**
	 * Gets a {@link Field} value by name. Only the class of the specified object
	 * will be considered.
	 * 
	 * @param target      the object to reflect, must not be {@code null}
	 * @param fieldName   the field name to obtain
	 ...
	 * @param value to set
	 * @throws IllegalArgumentException if the field is {@code null} or not
	 *                                  {@code static}, or {@code value} is not
	 *                                  assignable
	 * @throws IllegalAccessException   if the field is not {@code public} or is
	 *                                  {@code final}
	 */
	 ...
	 * @param value     to set
	 * @throws IllegalArgumentException if {@code cls} is {@code null}, the field
	 *                                  name is blank or empty, the field cannot be
	 *                                  located or is not {@code static}, or
	...
	/**
	 * Writes a named {@code public static} {@link Field}. Only the specified class
	 * will be considered.
	 * 
	 * @param cls       {@link Class} on which the field is to be found
	 * @param fieldName to write
	...
	/**
	 * Writes a named {@code static} {@link Field}. Only the specified class will be
	 * considered.
	 * 
	 * @param cls         {@link Class} on which the field is to be found
	 * @param fieldName   to write
	 ...
	 *               fields
	 * @param value  to set
	 * @throws IllegalAccessException if the field or target is {@code null}, the
	 *                                field is not accessible or is {@code final},
	 ...
	 *                    method. {@code false} will only match {@code public}
	 *                    fields.
	 * @throws IllegalArgumentException if the field is {@code null} or
	 *                                  {@code value} is not assignable
	 * @throws IllegalAccessException   if the field is not made accessible or is
	 *                                  {@code final}
	 */
