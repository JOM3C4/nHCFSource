...
/**
 * <p>
 * Type literal comparable to {@code javax.enterprise.util.TypeLiteral}, made
 * generally available outside the JEE context. Allows the passing around of a
 * "token" that represents a type in a typesafe manner, as opposed to passing
 * the (non-parameterized) {@link Type} object itself. Consider:
 * </p>
 * <p>
 ...
 * {@code java.lang.reflect.Type} to a type variable while simultaneously making
 * it short work to obtain a {@code Type} instance for any given type, inline.
 * </p>
 * <p>
 ...
 * classes. It is suggested that APIs be defined in terms of the interface, in
