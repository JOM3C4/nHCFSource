 ...
 * List.remove(A) on the correct list.
...
public class TLinkedList<T extends TLinkable<T>> extends AbstractSequentialList<T> implements Externalizable {
	...
	protected final class IteratorImpl implements ListIterator<T> {
		 ...
		 *
		 * @throws IllegalStateException neither next nor previous have been invoked, or
		 *                               remove or add have been invoked after the last
		 *                               invocation of next or previous.
		 */
		@SuppressWarnings({})
