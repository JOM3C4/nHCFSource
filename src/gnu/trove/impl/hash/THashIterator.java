...
public abstract class THashIterator<V> implements TIterator, Iterator<V> {
	 ...
	 * @throws ConcurrentModificationException if the structure was changed using a
	 *                                         method that isn't on this iterator.
	 * @throws NoSuchElementException          if this is called on an exhausted
	 *                                         iterator.
	 */
	public V next() {
		moveToNextIndex();
