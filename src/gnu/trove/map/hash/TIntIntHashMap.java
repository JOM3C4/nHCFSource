...
public class TIntIntHashMap extends TIntIntHash implements TIntIntMap, Externalizable {
	 ...
	 * @param initialCapacity an <code>int</code> value
	 * @param loadFactor      a <code>float</code> value
	 * @param noEntryKey      a <code>int</code> value that represents <tt>null</tt>
	 *                        for the Key set.
	 * @param noEntryValue    a <code>int</code> value that represents <tt>null</tt>
	 *                        for the Value set.
	 */
	 ...
	 *
	 * @param keys   a <tt>int</tt> array containing the keys for the matching
	 *               values.
