 ...
 * <p/>
 * The Main-Class entry in the manifest.mf should be set during the build as
 * well as the Implementation-Version manifest attribute should be set as well.
 * <p/>
...
public class Version {
	 ...
	 * <p/>
	 * NOTE: this method will only return a useful version when working with a
	 * trove4j jar as it requires a manifest file
	 *
	 * @return
	 */
