...
public class EventSignListener implements Listener {
	public static ItemStack getEventSign(String playerName, String kothName) {
		...
		meta.setLore(Lists.newArrayList(
				new String[] { ChatColor.AQUA + Base.getPlugin().getFactionManager().getFaction(playerName).getName(),
						ChatColor.GRAY + "captured by", ChatColor.AQUA + ChatColor.stripColor(name),
