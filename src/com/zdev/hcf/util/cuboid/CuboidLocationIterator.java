package com.zdev.hcf.util.cuboid;
...
public class CuboidLocationIterator implements Iterator<Location> {
	...
	public Location next() {
		final Location location = new Location(this.world, (double) (this.baseX + this.x),
				(double) (this.baseY + this.y), (double) (this.baseZ + this.z));
