				...
				if (value != null) {
					...
					if (!type.isAssignableFrom(value.getClass())) {
						...
						throw new AssertionError(
								(Object) ("Cannot cast to list! Key " + value + " is not a " + simpleName));
					}
		...
		if (object != null && object instanceof Map) {
			...
			for (final Object key : input.keySet().toArray()) {
				if (key != null && !keyClass.isAssignableFrom(key.getClass())) {
					throw new AssertionError((Object) ("Cannot cast to HashMap: " + keyClassName + ", " + keyClassName
							+ ". Value " + valueClassName + " is not a " + keyClassName));
				}
				final Object value = input.get(key);
				if (value != null && !valueClass.isAssignableFrom(value.getClass())) {
					throw new AssertionError((Object) ("Cannot cast to HashMap: " + valueClassName + ", "
